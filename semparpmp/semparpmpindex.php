...
/**
 *	\file       semparpmp/semparpmpindex.php
 *	\ingroup    semparpmp
 *	\brief      Home page of semparpmp top menu
 */
...
$langs->loadLangs(array("semparpmp@semparpmp"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->semparpmp->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("SEMPARPMPArea"));

print load_fiche_titre($langs->trans("SEMPARPMPArea"), '', 'semparpmp.png@semparpmp');
...
// Draft MyObject
if (! empty($conf->semparpmp->enabled) && $user->rights->semparpmp->read)
{
	$langs->load("orders");
