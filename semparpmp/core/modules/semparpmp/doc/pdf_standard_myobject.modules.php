...
/**
 *  \file       semparpmp/core/modules/semparpmp/doc/pdf_standard.modules.php
 *  \ingroup    semparpmp
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
	    ...
	    if ($conf->semparpmp->dir_output.'/myobject')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->semparpmp->dir_output.'/myobject';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->semparpmp->dir_output.'/myobject/'.$objectref;
