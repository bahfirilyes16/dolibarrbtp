...
/**
 *  \file       decompte_contact.php
 *  \ingroup    semparpmp
 *  \brief      Tab for contacts linked to Decompte
 */
...
$hookmanager->initHooks(array('decomptecontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$title = $langs->trans('Decompte')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id)
{
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Decompte"), -1, $object->picto);
